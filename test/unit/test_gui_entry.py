...
def test_run_gui_starts_application():
    ...
    fake_runtime = types.ModuleType("src.core.runtime_client")
    runtime_client = Mock()
    fake_runtime.RuntimeClient = Mock(return_value=runtime_client)
    ...
    with patch.dict(
        "sys.modules",
        {
            ...
            "src.core.runtime_client": fake_runtime,
    ...
    fake_runtime.RuntimeClient.assert_called_once_with()
